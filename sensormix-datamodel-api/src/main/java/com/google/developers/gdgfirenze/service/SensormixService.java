...
@WebService(name = "SensormixService", targetNamespace = "http://developers.google.com/gdgfirenze/ns/service")
...
public interface SensormixService {
	...
	List<AbstractSample> getSamples(@WebParam(name = "sensorId") String sensorId,
